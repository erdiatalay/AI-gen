...
ng-aquila provides a comprehensive typography system with directives for headings, body text, and specialized text styles. All typography follows accessibility best practices and responsive design principles.
...
---
*ng-aquila v20.6.0 Typography Guide*
