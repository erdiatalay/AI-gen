...
ng-aquila provides a comprehensive theming system based on CSS custom properties (CSS variables). You can customize colors, spacing, typography, and component-specific styles to match your brand.

## Default Theme

ng-aquila includes a default Allianz theme. The library can be used with:
...
- [ng-aquila Theming Documentation](https://allianz.github.io/ng-aquila/guides/theming)
- [CSS Custom Properties (MDN)](https://developer.mozilla.org/en-US/docs/Web/CSS/--*)
- [Contrast Checker](https://webaim.org/resources/contrastchecker/)

---
*ng-aquila v20.6.0 Theming Guide*
